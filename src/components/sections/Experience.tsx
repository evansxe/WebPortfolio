...
export default function Experience() {
  ...
  return (
    <section id="experience" className="scroll-mt-20 bg-slate-50 dark:bg-white/[0.03]">
            ...
            <div className="mt-4 flex flex-col gap-3">
              {education.map((entry) => (
                <div key={entry.institution} className="text-sm">
                  <p className="font-medium">{pickLocalized(entry.degree, i18n.language)}</p>
              ...
              {languages.map((entry) => (
                ...
                >
                  ...
                  <span className="text-slate-500 dark:text-slate-500">
                    · {pickLocalized(entry.level, i18n.language)}
                  </span>
                </span>
              ))}
            </div>
